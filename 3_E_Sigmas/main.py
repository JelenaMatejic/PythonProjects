...
# Kreiranje prozora
window = tk.Tk()
window.geometry("540x400") # zadavanje dimenzija prozoru
...
text_box_nondeterm = Text(window, width = 30, height = 20, spacing1 = 2)
text_box_nondeterm.grid(column=1, row=4)
# Text area polje za prikaz determinizacije automata
text_box_determ = Text(window, width = 45, height = 20, spacing1 = 2)
